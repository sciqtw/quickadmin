...
insert  into `qk_system_plugin`(`id`,`name`,`display_name`,`desc`,`avatar`,`version`,`status`,`is_deleted`,`deleted_at`,`create_by`,`created_at`,`updated_at`,`update_by`)
values (3,'crud','crud','快捷生成代码','','',1,0,'2022-02-25 11:30:06',0,'2022-02-25 11:30:06','2022-02-25 11:30:06',0);
